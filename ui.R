...
shinyUI(fluidPage(
  ...
  div(class="navbar navbar-static-top navbar", 
      div(class = 'navbar-inner',
        span(class = 'brand pull-left', list(img(src = 'gabz.png', width="40", height="40"), 'Gabviz')),
  ...
  div(id = 'full-width', class = 'modal container hide', style = 'width: 100%; margin: auto; left: 0', tabindex = '-1',
    ...
    div(class = 'modal-body',
          fluidRow(
           ...
           aceEditor("code", mode="sql", height = "250px", value=''),
  ...
  p('Powered by Gabviz@2015', align = 'left'),    
